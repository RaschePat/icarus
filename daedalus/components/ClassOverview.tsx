...
export default function ClassOverview({ students }: Props) {
  ...
  return (
    <div className="card flex flex-col gap-4">
      <div className="flex items-center justify-between">
        <h2 className="font-semibold text-sm">📊 학급 이해도 현황</h2>
      ...
      <div className="grid grid-cols-3 gap-3">
        {[
          ...
          {
            label: "완료",
            value: `${students.filter((s) => s.progress >= 100).length}명`,
            color: "text-emerald-300",
          },
          {
            label: "이탈 위험",
            value: `${redFlags.length}명`,
            color: redFlags.length > 0 ? "text-red-400" : "text-slate-300",
          },
